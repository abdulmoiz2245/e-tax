<x-base-layout>
    ...
    <div class="row gy-5 g-xl-4 mb-5" style="margin-top: 70px; ">
        ...
        <div class="col-md-12">
            <h1 class="dash-title">Totals Report</h1>
        </div>
        <!--end::Col--> 
    </div>
    ...
    <div class="row gy-5 gx-md-4" >
        <div class="col-md-12">
            <p class="dash-description-secondry font-questrial"> The Totals Report provides totals by form type and payer. It may be used in place of a 1096, W-3 or 1094-C/B.</p>
        </div>
    </div>
    <!--end::Row-->
