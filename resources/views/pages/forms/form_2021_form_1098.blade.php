<x-base-layout>
    ...
    <div class="row gy-5 g-xl-4 mb-5" style="margin-top: 50px; ">
        ...
        <div class="col-md-12" style="margin-bottom: 40px;">
            <h1 class="dash-title" style="margin-bottom: 18px; font-size:30px !important">2021 Form 1098</h1>
        </div>
        <!--end::Col-->
    </div>
    <!--end::Row-->
                    ...
                    <form action="" method="post">
                        <div class="col-md-6">
                            {{ theme()->getView('partials/widgets/form/input/_text',
                                    array( 
                                            'type' => 'text' ,
                                            'name' => 'royalities' ,
                                            'placeholder' => 'Mortgage interest received from payer(s)/borrower(s)' ,
                                            'required'=> true , 'id' => ''
                                        )
                                    )
                                }}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                {{ theme()->getView('partials/widgets/form/input/_text',
                                    array( 
                                            'type' => 'date' ,
                                            'name' => 'rent' ,
                                            'placeholder' => 'Mortgage origination date' ,
                                            'required'=> true , 'id' => ''
                                        )
                                    )
                                }}
                            ...
                            <div class="col-md-6">
                                {{ theme()->getView('partials/widgets/form/input/_text',
                                    array( 
                                            'type' => 'text' ,
                                            'name' => 'royalities' ,
                                            'placeholder' => 'Refund of overpaid interest' ,
                                            'required'=> true , 'id' => ''
                                        )
                                    )
                                }}
                            ...
                            <div class="col-md-6">
                                {{ theme()->getView('partials/widgets/form/input/_text',
                                    array( 
                                            'type' => 'text' ,
                                            'name' => 'royalities' ,
                                            'placeholder' => 'Mortgage insurance premiums' ,
                                            'required'=> true , 'id' => ''
                                        )
                                    )
                                }}
                            ...
                            <div class="col-md-6">
                                {{ theme()->getView('partials/widgets/form/input/_text',
                                    array( 
                                            'type' => 'text' ,
                                            'name' => 'royalities' ,
                                            'placeholder' => 'Points paid on purchase of principal residence' ,
                                            'required'=> true , 'id' => ''
                                        )
                                    )
                                }}
                            ...
                            <div class="col-md-12" style="padding-top: 15px;">
                                ...
                                <label for="vehicle1">If address of property securing mortgage is the same as PAYERS/BORROWERS address, check the box, or enter the address or description in box 8.</label>
                            </div>
                            ...
                            <div class="col-md-12">
                                {{ theme()->getView('partials/widgets/form/input/_text',
                                    array( 
                                            'type' => 'text' ,
                                            'name' => 'royalities' ,
                                            'placeholder' => 'Address or description of property securing mortgage (see instructions)' ,
                                            'required'=> true , 'id' => ''
                                        )
                                    )
                                }}
