<x-base-layout>
    ...
    <div class="row gy-5 g-xl-4 mb-5" style="margin-top: 50px; ">
        ...
        <div class="col-md-12" style="margin-bottom: 40px;">
            <h1 class="dash-title" style="margin-bottom: 18px; font-size:30px !important">2021 Form 1099-DIV</h1>
        </div>
        <!--end::Col-->
    </div>
    <!--end::Row-->
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                {{ theme()->getView('partials/widgets/form/input/_text',
                                    array( 
                                            'type' => 'text' ,
                                            'name' => 'rent' ,
                                            'placeholder' => '1a Total ordinary dividends' ,
                                            'required'=> true , 'id' => ''
                                        )
                                    )
                                }}
                            ...
                            <div class="col-md-6">
                                {{ theme()->getView('partials/widgets/form/input/_text',
                                    array( 
                                            'type' => 'text' ,
                                            'name' => 'royalities' ,
                                            'placeholder' => '1b Qualified dividends' ,
                                            'required'=> true , 'id' => ''
                                        )
                                    )
                                }}
                            ...
                            {{ theme()->getView('partials/widgets/form/input/_text',
                                    array( 
                                            'type' => 'text' ,
                                            'name' => 'royalities' ,
                                            'placeholder' => '2a Total capital gain distr.' ,
                                            'required'=> true , 'id' => ''
                                        )
                                    )
                                }}
                            ...
                            {{ theme()->getView('partials/widgets/form/input/_text',
                                    array( 
                                            'type' => 'text' ,
                                            'name' => 'royalities' ,
                                            'placeholder' => '2b Unrecap. Sec. 1250 gain' ,
                                            'required'=> true , 'id' => ''
                                        )
                                    )
                                }}
                            ...
                            <div class="col-md-6">
                                {{ theme()->getView('partials/widgets/form/input/_text',
                                            array( 
                                                    'type' => 'text' ,
                                                    'name' => 'zip_code' ,
                                                    'placeholder' => '2c Section 1202 gain' ,
                                                    'required'=> true , 'id' => ''
                                                )
                                            )
                                        }}
                            ...
                            <div class="col-md-6">
                                {{ theme()->getView('partials/widgets/form/input/_text',
                                            array( 
                                                    'type' => 'text' ,
                                                    'name' => 'zip_code' ,
                                                    'placeholder' => '2d Collectibles (28%) gain' ,
                                                    'required'=> true , 'id' => ''
                                                )
                                            )
                                        }}
                            ...
                            <div class="col-md-6">
                                {{ theme()->getView('partials/widgets/form/input/_text',
                                            array( 
                                                    'type' => 'text' ,
                                                    'name' => 'zip_code' ,
                                                    'placeholder' => '2e Section 897 Ordinary Dividends' ,
                                                    'required'=> true , 'id' => ''
                                                )
                                            )
                                        }}
                            ...
                            <div class="col-md-6">
                                {{ theme()->getView('partials/widgets/form/input/_text',
                                            array( 
                                                    'type' => 'text' ,
                                                    'name' => 'zip_code' ,
                                                    'placeholder' => '2f Section 897 Capital Gain' ,
                                                    'required'=> true , 'id' => ''
                                                )
                                            )
                                        }}
                            ...
                            <div class="col-md-6">
                                {{ theme()->getView('partials/widgets/form/input/_text',
                                            array( 
                                                    'type' => 'text' ,
                                                    'name' => 'zip_code' ,
                                                    'placeholder' => '3 Nondividend distributions' ,
                                                    'required'=> true , 'id' => ''
                                                )
                                            )
                                        }}
                            ...
                            <div class="col-md-6">
                                {{ theme()->getView('partials/widgets/form/input/_text',
                                            array( 
                                                    'type' => 'text' ,
                                                    'name' => 'zip_code' ,
                                                    'placeholder' => '5 Section 199A dividends' ,
                                                    'required'=> true , 'id' => ''
                                                )
                                            )
                                        }}
                            ...
                            <div class="col-md-6">
                                {{ theme()->getView('partials/widgets/form/input/_text',
                                            array( 
                                                    'type' => 'text' ,
                                                    'name' => 'zip_code' ,
                                                    'placeholder' => '6 Investment expenses' ,
                                                    'required'=> true , 'id' => ''
                                                )
                                            )
                                        }}
                            ...
                            <div class="col-md-6">
                                {{ theme()->getView('partials/widgets/form/input/_text',
                                            array( 
                                                    'type' => 'text' ,
                                                    'name' => 'zip_code' ,
                                                    'placeholder' => 'Foreign country or U.S. possession' ,
                                                    'required'=> true , 'id' => ''
                                                )
                                            )
                                        }}
                            ...
                            <div class="col-md-6">
                                {{ theme()->getView('partials/widgets/form/input/_text',
                                            array( 
                                                    'type' => 'text' ,
                                                    'name' => 'zip_code' ,
                                                    'placeholder' => 'Cash liquidation distributions' ,
                                                    'required'=> true , 'id' => ''
                                                )
                                            )
                                        }}
                            ...
                            <div class="col-md-6">
                                {{ theme()->getView('partials/widgets/form/input/_text',
                                            array( 
                                                    'type' => 'text' ,
                                                    'name' => 'zip_code' ,
                                                    'placeholder' => 'Noncash liquidation distributions' ,
                                                    'required'=> true , 'id' => ''
                                                )
                                            )
                                        }}
                            ...
                            <div class="col-md-6">
                                {{ theme()->getView('partials/widgets/form/input/_text',
                                            array( 
                                                    'type' => 'text' ,
                                                    'name' => 'zip_code' ,
                                                    'placeholder' => '11 Exempt-interest dividends' ,
                                                    'required'=> true , 'id' => ''
                                                )
                                            )
                                        }}
                            ...
                            <div class="col-md-6">
                                {{ theme()->getView('partials/widgets/form/input/_text',
                                            array( 
                                                    'type' => 'text' ,
                                                    'name' => 'zip_code' ,
                                                    'placeholder' => '12 Specified private activity bond interest dividends' ,
                                                    'required'=> true , 'id' => ''
                                                )
                                            )
                                        }}
