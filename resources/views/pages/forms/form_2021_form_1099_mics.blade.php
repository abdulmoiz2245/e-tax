                ...
                <div class="card-body billing-form d-flex flex-column pt-3 pb-3 justify-content-end">
                    <form action="" method="post">
                            ...
                            <div class="col-md-6">
                                {{ theme()->getView('partials/widgets/form/input/_text',
                                    array( 
                                            'type' => 'text' ,
                                            'name' => 'rent' ,
                                            'placeholder' => 'Payments received for qualified tuition and related expenses' ,
                                            'required'=> true , 'id' => ''
                                        )
                                    )
                                }}
                            ...
                            <div class="col-md-6">
                                {{ theme()->getView('partials/widgets/form/input/_text',
                                    array( 
                                            'type' => 'text' ,
                                            'name' => 'royalities' ,
                                            'placeholder' => 'Adjustments made for a prior year' ,
                                            'required'=> true , 'id' => ''
                                        )
                                    )
                                }}
                            ...
                            <div class="col-md-6">
                                {{ theme()->getView('partials/widgets/form/input/_text',
                                            array( 
                                                    'type' => 'text' ,
                                                    'name' => 'zip_code' ,
                                                    'placeholder' => 'Adjustments to scholarships or grants for a prior year' ,
                                                    'required'=> true , 'id' => ''
                                                )
                                            )
                                        }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12" style="padding-top: 15px;">
                                <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike">
                                <label for="vehicle1">Check if at least half-time student</label>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12" style="padding-top: 15px;">
                                <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike">
                                <label for="vehicle1">Check if a graduate student</label>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                {{ theme()->getView('partials/widgets/form/input/_text',
                                            array( 
                                                    'type' => 'text' ,
                                                    'name' => 'zip_code' ,
                                                    'placeholder' => 'Ins. contract reimb./refund' ,
                                                    'required'=> true , 'id' => ''
                                                )
                                            )
                                        }}
