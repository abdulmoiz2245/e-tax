<x-base-layout>
    ...
    <div class="row gy-5 g-xl-4 mb-5" style="margin-top: 50px; ">
        ...
        <div class="col-md-12" style="margin-bottom: 40px;">
            <h1 class="dash-title" style="margin-bottom: 18px; font-size:30px !important">2021 Form 1099-S</h1>
        </div>
        <!--end::Col-->
    </div>
    <!--end::Row-->
                ...
                <div class="card-body billing-form d-flex flex-column pt-3 pb-3 justify-content-end">
                    <form action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                {{ theme()->getView('partials/widgets/form/input/_text',
                                    array( 
                                            'type' => 'text' ,
                                            'name' => 'royalities' ,
                                            'placeholder' => '3 Address (including city, state, and ZIP code) or legal description' ,
                                            'required'=> true , 'id' => ''
                                        )
                                    )
                                }}
                            ...
                            <div class="col-md-6">
                                {{ theme()->getView('partials/widgets/form/input/_text',
                                    array( 
                                            'type' => 'text' ,
                                            'name' => 'royalities' ,
                                            'placeholder' => '6 Buyers part of real estate tax' ,
                                            'required'=> true , 'id' => ''
                                        )
                                    )
                                }}
                            ...
                            <div class="col-md-12" style="padding-top: 15px;">
                                <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike">
                                <label for="vehicle1">Check here if the transferor received or will receive property or services as part of the consideration</label>
                            </div>
                            <div class="col-md-12" style="padding-top: 15px;">
                                <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike">
                                <label for="vehicle1">Check here if the transferor is a foreign person (nonresident alien, foreign partnership, foreign estate, or foreign trust)</label>
                            </div>
