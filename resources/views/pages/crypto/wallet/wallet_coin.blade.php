    ...
    <div class="row gy-5 g-xl-4 mb-5" style="margin-top: 50px; ">
        ...
        <div class="col-md-12" style="margin-bottom: 26px;">
            <h1 class="dash-title" style="margin-bottom: 18px; font-size:30px !important">
                <span><img class="me-3" src="{{ asset(theme()->getMediaUrlPath() . 'img/coinbase.png') }}" width="48" height="48" alt=""></span>
                Coinbase
            </h1>
        </div>
    </div>
        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <table class="table crypto_table" style="padding-right:24px">
                    <thead>
                        <tr>
                            <th scope="col" style="padding-left: 20px;">Coin
                                <span>
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_386_67)">
                                            <path d="M8.96247 5.9625L7.90198 7.023L5.99998 5.121V15H4.49998V5.121L2.59873 7.023L1.53748 5.9625L5.24998 2.25L8.96247 5.9625ZM16.4625 12.0375L12.75 15.75L9.03747 12.0375L10.098 10.977L12.0007 12.879L12 3H13.5V12.879L15.402 10.977L16.4625 12.0375V12.0375Z" fill="black" fill-opacity="0.7" />
                                        </g>
                                        <defs>
                        ...
                        <tr>
                            <td>
                                <div class="icon d-md-flex " style="padding-left: 20px;">
                                    ...
                                    <p class="f-16-fig pl-3" style="color:#0052FE;margin-bottom: 0;padding-left:20px">{{$user_wallet_info->wallet_name}}</p>

                                </div>
                            </td>
                            <td>
                                <p class="f-16-fig pl-3" style="color:#000000;margin-bottom: 0;">{{$user_wallet_info->wallet_amount }}</p>
    ...
    <div class="d-flex justify-content-end" style="margin-top: 16px;">
        <span style="padding-right: 12px;">
            <button class="btn f-14-neu-400-fig crypto-badge-success ">
                @if(isset($user_wallet_info->transactions))
                {{$user_wallet_info->transactions}}
                @else
                No
                @endif
                transaction
        ...
        <span style="padding-right: 12px;">
            <button class="btn f-14-neu-400-fig crypto-badge-secondary ">
                @if(isset($user_wallet_info->deposits))
                {{$user_wallet_info->deposits}}
                @else
                No
                @endif
                deposits
        ...
        <span style="padding-right: 12px;">
            <button class="btn f-14-neu-400-fig crypto-badge-secondary ">
                @if(isset($user_wallet_info->withdrawals))
                {{$user_wallet_info->withdrawals}}
                @else
                No
                @endif
                withdrawals
