                            ...
                            <tr>
                                <td>
                                    <div class="icon d-md-flex " style="padding-left: 20px;">
                                        ...
                                        <p class="f-16-fig pl-3" style="color:#0052FE;margin-bottom: 0;padding-left:20px">{{$result->data[$i]->balance->currency}}</p>

                                    </div>
                                </td>
                                <td>
                                    <p class="f-16-fig pl-3" style="color:#000000;margin-bottom: 0;">{{$result->data[$i]->balance->amount}}</p>
